    ...
    <nav class="sidebar px-2 py-1 shadow-md">
        <ul class="nav-list p-0">
            <li class="d-flex flex-column">
                ...
                <a href="{{ route('dashboard') }}" class="text-center"><img src="" alt="Logo" style="max-width: 150px;"></a>
            </li>
            ...
            <li><a class="nav-link {{ $title=='Knapsack' ? 'text-warning' : 'text-white' }}" href="{{ route('knapsack.index') }}"><i class="fa fa-tachometer-alt" aria-hidden="true"></i> Knapsack</a></li>
        </ul>
